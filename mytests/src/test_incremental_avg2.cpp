...
void align_and_accumulate(size_t num_tests = 0)
{
    ...
    for (int rel_time = TEST_START_TIME; rel_time <= TEST_END_TIME; rel_time += TEST_STEP_TIME)
    {
        ...
        else
        {
            ...
            // Actualizar min
            if (force > 0 && force < acc_item->min)
            {
                //acc_item->min = force;
            }
        }
        // Si después de actualizar sigue siendo std::numeric_limits<float>::max(), establecerlo en 0
        if (acc_item->min == std::numeric_limits<float>::max())
        {
            //acc_item->min = 0;
        }
    }
...
void setup()
{
    ...
    delay(1000);
/*
     -300 |    0.00 |   15.00 (  15.00-  15.00)
     -200 |    6.00 |   21.00 (  21.00-  21.00)
     -100 |   12.00 |   27.00 (  27.00-  27.00)
*/
    // Primera prueba
    const char *json1 = R"([
        {"d":12.0,"f":27.0,"t":100},
...
output:
--- Estadísticas Actualizadas ---
TiempoRel | AvgDist | AvgForce (Min-Max)
     -300 |    0.00 |   15.00 (  15.00-  15.00)
     -200 |    6.00 |   21.00 (  21.00-  21.00)
     -100 |   12.00 |   27.00 (  27.00-  27.00)
        0 |   18.00 |   33.00 (  33.00-  33.00)
      100 |   24.00 |   10.00 (  10.00-  10.00)
      200 |   28.00 |    0.00 (   0.00-   0.00)
      300 |   32.00 |    0.00 (   0.00-   0.00)
Número de pruebas realizadas: 0

--- Estadísticas Actualizadas ---
TiempoRel | AvgDist | AvgForce (Min-Max)
     -300 |    2.50 |   17.50 (  15.00-  20.00)
     -200 |    8.00 |   23.00 (  21.00-  25.00)
     -100 |   13.50 |   28.50 (  27.00-  30.00)
        0 |   19.00 |   34.00 (  33.00-  35.00)
      100 |   24.50 |   10.00 (  10.00-  10.00)
      200 |   29.00 |    1.00 (   2.00-   2.00)
      300 |   33.50 |    0.50 (   1.00-   1.00)
Número de pruebas realizadas: 0
*/
